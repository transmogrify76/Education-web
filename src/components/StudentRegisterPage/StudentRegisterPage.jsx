...
const StudentRegisterPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Check for successful response and success flag in data
            if (response.ok && data.success) {
                ...
                // Show error message based on server's response
                console.error('Registration failed:', data.message);
                alert(`Error: ${data.message}`); // You can display the error message using an alert or any other UI component.
            }
        } catch (error) {
